    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/db.EducationMaterial"
                            }
                        }
                    },
                    "400": {
        ...
        "/education-materials/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Education Material ID (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/db.QuizSubmission"
                            }
                        }
                    },
                    "401": {
        ...
        "/nakes/children": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Child Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateChildrenRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nakes/children/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Child Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateChildRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nakes/children/{id}/measurements": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/db.Measurement"
                            }
                        }
                    },
                    "400": {
        ...
        "/nakes/education-materials": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Education Material Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateEducationMaterialRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nakes/education-materials/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Education Material Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateEducationMaterialRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nakes/measurements": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Measurement Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateMeasurementRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nakes/measurements/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Measurement ID (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Measurement Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateMeasurementRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nakes/quizzes": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create Quiz Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateQuizRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateQuizQuestionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/db.QuizQuestion"
                        }
                    },
                    "400": {
                        "description": "Validation error or invalid quiz ID",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
        ...
        "/nakes/quizzes/{id}/questions/{question_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateQuizQuestionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/nakes/quizzes/{id}/submissions/{submission_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/quizzes/{id}/submissions": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Quiz Submission Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateQuizSubmissionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "db.Measurement": {
            ...
            "properties": {
                ...
                "stuntingStatus": {
                    "$ref": "#/definitions/db.NullStuntingStatus"
                },
        ...
        "db.NullStuntingStatus": {
            "type": "object",
            "properties": {
                "stuntingStatus": {
                    "$ref": "#/definitions/db.StuntingStatus"
                },
                "valid": {
                    "description": "Valid is true if StuntingStatus is not NULL",
                    "type": "boolean"
                }
            }
        },
        ...
        "db.QuizQuestion": {
            ...
            "properties": {
                ...
                "questionType": {
                    "$ref": "#/definitions/db.QuestionType"
                },
                "quizID": {
                    "type": "string"
                }
        ...
        "db.StuntingStatus": {
            ...
            "x-enum-varnames": [
                "StuntingStatusSeverelyStunted",
                "StuntingStatusStunted",
                "StuntingStatusNormal",
                "StuntingStatusTall"
            ]
        },
        "db.UserRole": {
        ...
        "handler.CreateEducationMaterialRequest": {
            "type": "object",
            "required": [
                "title"
            ],
        ...
        "handler.CreateMeasurementRequest": {
            "type": "object",
            "required": [
                "children_id",
                "height",
        ...
        "handler.CreateQuizQuestionRequest": {
            "type": "object",
            "required": [
                "options",
                "question_text",
        ...
        "handler.CreateQuizSubmissionRequest": {
            "type": "object",
            "required": [
                "answers"
            ],
        ...
        "handler.UpdateEducationMaterialRequest": {
            "type": "object",
            "required": [
                "title"
            ],
        ...
        "handler.UpdateMeasurementRequest": {
            "type": "object",
            "required": [
                "height",
                "weight"
        ...
        "handler.UpdateQuizQuestionRequest": {
            "type": "object",
            "required": [
                "options",
                "question_text",
