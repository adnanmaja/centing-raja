import svgPaths from "./svg-35d2760dwo";
import imgLogoCentingRaja from "./7de6f99be5b1285d73c8291a2717fd5004f4c8f2.png";
import imgBackgroundShadow from "./aa67e5671e5aef4ce81ab557b31e820613b8f113.png";
...
function BackgroundShadow8() {
  return <div className="absolute bg-size-[512px_279px] bg-top-left h-[320px] left-[133.79px] right-[910.85px] rounded-[20px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] top-[91px]" style={{ backgroundImage: `url("${imgBackgroundShadow}")` }} data-name="Background+Shadow" />;
}

function BackgroundShadow9() {
  return <div className="absolute bg-size-[512px_279px] bg-top-left h-[320px] left-[520.27px] right-[524.36px] rounded-[20px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] top-[91px]" style={{ backgroundImage: `url("${imgBackgroundShadow}")` }} data-name="Background+Shadow" />;
}

function BackgroundShadow10() {
  return <div className="absolute bg-size-[512px_279px] bg-top-left h-[320px] left-[915.64px] right-[129px] rounded-[20px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] top-[91px]" style={{ backgroundImage: `url("${imgBackgroundShadow}")` }} data-name="Background+Shadow" />;
}

function Group2() {
  return (
    <div className="absolute contents left-[133.79px] right-[129px] top-[91px]">
      <BackgroundShadow8 />
      <BackgroundShadow9 />
      <BackgroundShadow10 />
    </div>
  ...
  return (
    <div className="[word-break:break-word] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 flex flex-col font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold justify-center ml-0 mt-0 relative row-1 text-[32px] text-black text-center tracking-[-0.64px] whitespace-nowrap">
        <p className="leading-[40px]">Panduan Detail Nakes</p>
      </div>
...
function Background1() {
  return (
    <div className="absolute bg-gradient-to-t content-stretch flex flex-col from-[rgba(0,109,66,0.9)] h-[320px] items-start justify-end left-[130px] p-[20px] rounded-[20px] to-[rgba(0,109,66,0.2)] top-[91px] w-[1181px]" data-name="Background">
      <Group7 />
    </div>
  );
}
...
export default function PanduanUntukNakesDesktop() {
  return (
    <div className="bg-white relative size-full" data-name="Panduan Untuk Nakes Desktop">
      <Header />
      <WelcomeCard />
      <Group1 />
