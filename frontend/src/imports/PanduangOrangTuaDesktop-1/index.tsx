import svgPaths from "./svg-w2omkr1r8";
...
function Background() {
  return (
    <div className="[word-break:break-word] absolute bg-gradient-to-t content-stretch flex flex-col from-[rgba(0,109,66,0.9)] h-[320px] items-start justify-end leading-[0] left-0 p-[20px] rounded-[20px] to-[rgba(0,109,66,0.2)] top-0 w-[1181px] whitespace-nowrap" data-name="Background">
      <div className="flex flex-col font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[32px] text-black text-center tracking-[-0.64px]">
        <p className="leading-[40px]">{`Panduan Detail Orang Tua `}</p>
      </div>
      <div className="flex flex-col font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-normal justify-center relative shrink-0 text-[16px] text-white">
        <p className="leading-[24px] mb-0">Selamat Datang di Centing Raja</p>
        <p className="leading-[24px]">{`Bersama kita pantau tumbuh kembang si kecil dengan mudah dan akurat dari rumah `}</p>
      </div>
    </div>
  );
}
...
function HeroSection() {
  return (
    <div className="absolute bg-size-[512px_279px] bg-top-left h-[320px] left-[130px] overflow-clip rounded-[20px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] top-[78px] w-[1181px]" style={{ backgroundImage: `url("${imgHeroSection}")` }} data-name="Hero Section">
      <Background />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute contents left-[130px] top-[78px]">
      <HeroSection />
    </div>
  );
}
...
export default function PanduangOrangTuaDesktop() {
  return (
    <div className="bg-white relative size-full" data-name="Panduang Orang Tua Desktop">
      <Header />
      <Group />
      <WelcomeCard />
      <Group2 />
